...
function About() {
  ...
  return (
    <div ref={scrollRef} data-scroll-container>
      <div style={{ marginTop: '200px' }} data-scroll data-scroll-section data-scroll-speed="-.3" className='p-20 w-full bg-[#FFC96F] rounded-tl-3xl rounded-tr-3xl text-black font-["Neue_Montreal"] '>
